...
public class CashSendTransaction extends BaseClass {
    ...
    */
    ...
    public void ClickCashsend() throws InterruptedException {
        ...
        PaymentsPage.ClickCashSendLink();
    }
    ...
    public void SelectAccountNofromDD() throws InterruptedException {
        PaymentsPage.ClickFromAccDDCashsendSingle();
        PaymentsPage.SelectFromAccCashsendSingle("4048405107");
    ...
    public void VerifyTransactionStatus() throws InterruptedException, IOException {
        PaymentsPage.Checktranscationstatus();
